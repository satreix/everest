...
http_archive(
    ...
    sha256 = "3c80907277ac421cf9a9fd5f6c008f7db2565be7e4b051b5467c8c750aea4dd0",
    strip_prefix = "grammars-v4-43fbb16fec1d474d38a603cc6a6bcbe5edf07b1e",
    url = "https://github.com/antlr/grammars-v4/archive/43fbb16fec1d474d38a603cc6a6bcbe5edf07b1e.tar.gz",
)
...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_go/releases/download/v0.40.0/rules_go-v0.40.0.zip",
)
...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_java/releases/download/6.1.1/rules_java-6.1.1.tar.gz",
)
...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_python/archive/0.23.1.tar.gz",
)
