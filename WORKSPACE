...
http_archive(
    ...
    sha256 = "79bd9d0c9d728540c40a22fe88668c84954c34f140f08a3d9daba9feb903d712",
    strip_prefix = "grammars-v4-c4775c1c07ef227055682c65cece28add2233782",
    urls = ["https://github.com/antlr/grammars-v4/archive/c4775c1c07ef227055682c65cece28add2233782.tar.gz"],
)
...
http_archive(
    ...
    sha256 = "8ed50f019870705ad681bde9131c7d2e3dae8431d837733bd163492d9a99bcd8",
    strip_prefix = "googletest-66366cea569337c53c7ef1c72f84b566746e465e",
    urls = ["https://github.com/google/googletest/archive/66366cea569337c53c7ef1c72f84b566746e465e.zip"],
)
...
http_archive(
    ...
    urls = ["https://github.com/protocolbuffers/protobuf/archive/refs/tags/v3.21.9.tar.gz"],
)
...
http_archive(
    ...
    urls = ["https://github.com/bazelbuild/rules_python/archive/0.13.0.tar.gz"],
)
...
http_archive(
    ...
    urls = [
        "https://mirror.bazel.build/github.com/bazelbuild/rules_rust/releases/download/0.12.0/rules_rust-v0.12.0.tar.gz",
        "https://github.com/bazelbuild/rules_rust/releases/download/0.12.0/rules_rust-v0.12.0.tar.gz",
    ],
)
