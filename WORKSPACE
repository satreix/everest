...
http_archive(
    ...
    sha256 = "c0f0bc599dc022d5fc30741cbe759ebed2127b7c6dde87e51ea6e3613be7e16b",
    strip_prefix = "grammars-v4-cffc5bc072d2adb10fbfdc610ccc29733e5dbc67",
    urls = ["https://github.com/antlr/grammars-v4/archive/cffc5bc072d2adb10fbfdc610ccc29733e5dbc67.tar.gz"],
)
...
http_archive(
    ...
    sha256 = "f9fdb358aa1daa5909f437eb225c9cef9f21654dd7395a5df1a0eb7975b13a65",
...
http_archive(
    ...
    urls = ["https://github.com/grpc/grpc-java/archive/v1.53.0.tar.gz"],
)
...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_cc/archive/0.0.5.tar.gz",
)
...
http_archive(
    ...
    urls = ["https://github.com/bazelbuild/rules_perl/archive/7f10dada09fcba1dc79a6a91da2facc25e72bd7d.tar.gz"],
)
...
http_archive(
    ...
    urls = ["https://github.com/bazelbuild/rules_python/archive/0.16.2.tar.gz"],
)
