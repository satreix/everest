...
http_archive(
    ...
    sha256 = "23e29e98ee7baf9d37f31925b6a8f11b325cf24a44239264e595aeef9671025a",
    strip_prefix = "grammars-v4-586f045f6cafb420b9e823dc9cbfd25799d932e4",
    urls = ["https://github.com/antlr/grammars-v4/archive/586f045f6cafb420b9e823dc9cbfd25799d932e4.tar.gz"],
)
...
http_archive(
    ...
    sha256 = "a1ce0fcf8212b81dadd6befad733b5053c66021d6f9ff3a3fae21f065916ee30",
    strip_prefix = "googletest-9c332145b71c36a5bad9688312c79184f98601ff",
    urls = ["https://github.com/google/googletest/archive/9c332145b71c36a5bad9688312c79184f98601ff.zip"],
)
...
http_archive(
    ...
    urls = ["https://github.com/bazelbuild/rules_python/archive/0.14.0.tar.gz"],
)
...
http_archive(
    ...
    urls = [
        "https://mirror.bazel.build/github.com/bazelbuild/rules_rust/releases/download/0.13.0/rules_rust-v0.13.0.tar.gz",
        "https://github.com/bazelbuild/rules_rust/releases/download/0.13.0/rules_rust-v0.13.0.tar.gz",
    ],
)
