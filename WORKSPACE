...
http_archive(
    ...
    url = "https://github.com/antlr/grammars-v4/archive/cffc5bc072d2adb10fbfdc610ccc29733e5dbc67.tar.gz",
)
...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_rust/releases/download/0.16.1/rules_rust-v0.16.1.tar.gz",
)
