...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_bazel_contrib_target_determinator",
        importpath = "github.com/bazel-contrib/target-determinator",
        sum = "h1:2acmnbb+AfOYoSs/P4zSLmOiKH0p+FbLXITAi1Fxr4w=",
        version = "v0.16.0",
    )
    go_repository(
