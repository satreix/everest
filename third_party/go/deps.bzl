...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:A0H2c5IvFwyNSdXgGi9EfRiam50odcG0tXTVJxIiCAQ=",
        version = "v4.0.0-20230521174218-873a01ca2939",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jOQ72MdgW7H2ijx0sLDN8RyQBt+UVzq4+aEnWkj+Hz8=",
        version = "v1.9.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:B/s7HG33iwus4cwd8NsPk9H6nLKJpLcLgGV2D9RkfsI=",
        version = "v0.41.1",
    )
    go_repository(
        ...
        sum = "h1:KXWR7rFIuQLMo/dHu/DTev7qdQdTuGCxTfEUZdLaMfs=",
        version = "v0.41.1",
    )
    go_repository(
        ...
        sum = "h1:Y9Dk1kR93eSHadRTkqnm+QyQVhHthCcvTkoP/Afh7+4=",
        version = "v1.16.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MSGZwWn8Ji4b6UWkB7pYPgTiTmWM3S4lro9Y+5c3WmE=",
        version = "v0.38.1",
    )
    go_repository(
        ...
        sum = "h1:lIhD5oa2k9Lw4oxtl1ECNOrPaX61NjRo8hp+8lDEn4w=",
        version = "v0.38.1",
    )
    go_repository(
        ...
        sum = "h1:I/hA2cEzAaYNIieIkQ1v3D+hjMfDJHzp17kGje5+Wgo=",
        version = "v0.38.1",
    )
    go_repository(
