...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:iTgVZor2x9okXtmTrqO8cg4uvqIeaBcWhXtruaWFMYQ=",
        version = "v0.15.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:yzc6xDHdJM70GjvB6x1nbSqq/m0XquxolSlEWm8gQhU=",
        version = "v0.5.4",
    )
    go_repository(
        ...
        sum = "h1:n25rTbhmNgdtUnaCH1q58UqfLbVrLHXc/LT1XNoaQx0=",
        version = "v1.8.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:pWlIooxHVVdetyXFDsuzfqV42lXVIDmVGBCHeaXzDyI=",
        version = "v0.41.0",
    )
    go_repository(
        ...
        sum = "h1:y0WbLvc9kyZMBJ59obpNSAqrVoYIaa2auUtJET47mRI=",
        version = "v0.41.0",
    )
    go_repository(
        ...
        sum = "h1:536lQ8kbSVZvjuPt+8E/ix3oo0lHiSgh0bKJQ0N7Snc=",
        version = "v0.41.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:iBNejawWy7wWZ5msuZDNcMjBy14Wc0v3gCAXukGHN/Q=",
        version = "v1.15.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:yrZB4yN5wfL3xYtpr7sToqg+d7we6JmmQKVUhwEiSCU=",
        version = "v0.38.0",
    )
    go_repository(
        ...
        sum = "h1:VbOU5gwBVxCdavUhJrpvyMwrg3B0CvEwroh8IpBnuW4=",
        version = "v0.38.0",
    )
    go_repository(
        ...
        sum = "h1:1jZzoJih/dDFVfVO9JxCeIaVagsSlWfTH8ws5bpwBo8=",
        version = "v0.38.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rHD0vfQbtki6/FnsMzTpAOgdv+Ku+T6R47MZXmgelf8=",
        version = "v1.15.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:vv/Nv/44S3GzMMmeUhaesBKsAenE6xLkTVWL+zuv30w=",
        version = "v0.38.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:c/6/VZihe+5ink8ERufY1/o1QtnoON+k1YonZF2jYR4=",
        version = "v0.38.0",
    )
    go_repository(
