...
def raze_fetch_remote_crates():
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:ansi_term-0.11.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:atty-0.2.13.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:bitflags-1.2.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:clap-2.33.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:libc-0.2.66.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:strsim-0.8.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:textwrap-0.11.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:unicode-width-0.1.6.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:vec_map-0.8.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:winapi-0.3.8.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:winapi-i686-pc-windows-gnu-0.4.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//src/rust/hello_world/remote:winapi-x86_64-pc-windows-gnu-0.4.0.BUILD"),
    )
